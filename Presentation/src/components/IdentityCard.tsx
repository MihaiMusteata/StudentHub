                            ...
                            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div className="d-flex justify-content-between align-items-center bg-gradient-info shadow-info border-radius-lg pt-4 pb-3 px-3">
                                    ...
                                    <div className="bg-white border-radius-md">
                                        <button className="btn btn-outline-info btn-sm mb-0 border-0" onClick={() => handleOk()}>Save Changes</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table className="table mb-0">
                                        ...
                                        <tbody>
                                            {state.map((field, index) => (
                                                <>
                                                    <tr key={index} onClick={() => handleRowClick(field.key)} style={{ cursor: field.editable ? 'pointer' : 'default', height: '30px' }} >
                                                        <td className="text-end" style={{ width: '30%', fontWeight: 'bold', padding: '10px' }}>{field.label}</td>
                                                        <td className="text-start" style={{ width: '70%', padding: '10px' }}>
                                                            {editingField === field.key && field.editable ? (
                                                                <>
                                                                    ...
                                                                    >
                                                                        <Form.Item
                                                                            ...
                                                                            style={{ margin: '0', alignContent: 'center', justifyContent: 'center', width: '100%'}}
                                                                        >
                                                                            {field.type === 'text' && (
                                                                                <Input
                                                                                    styles={{
                                                                ...
                                                                <>
                                                                    <span>
                                                                        {field.type === 'select' && field.options ? field.options.find(option => option.value === field.value)?.label : field.value}
                                                                    </span>
                                                                </>
                                                            )}
                                                        </td>
