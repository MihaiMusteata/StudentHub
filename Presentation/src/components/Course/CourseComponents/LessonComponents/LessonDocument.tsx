...
import { LoadingOutlined, FileWordTwoTone, FilePdfTwoTone, FileExcelTwoTone, FileImageTwoTone, FileTextTwoTone, FileZipTwoTone, } from '@ant-design/icons';
...
const LessonDocument = ({setDocumentTrigger, name, extension, documentId}: LessonDocumentProps) => {
  ...
  const downloadFile = async () => {
    await ApiDownloadDocument(name, extension, 'downloadDocument', setProgress, setIsLoading, setToastComponent, {documentId: documentId})
  };
  ...
  return (
    <>
      <Spin spinning={isLoading} indicator={<></>}>
        <div className='col-12 text-dark d-flex align-items-center'>
          <div className='d-flex cursor-pointer' onClick={() => downloadFile()}>
            {
